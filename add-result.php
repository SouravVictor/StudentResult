...
for($i=0;$i<count($ct);$i++){
    $c=$ct[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult(StudentId,ClassId,SubjectId,ct,wt,pro,ter) VALUES(:studentid,:class,:sid,:ct,:wt,:pro,:ter)";
$query = $dbh->prepare($sql);
$query->bindParam(':studentid',$studentid,PDO::PARAM_STR);
$query->bindParam(':class',$class,PDO::PARAM_STR);
$query->bindParam(':sid',$sid,PDO::PARAM_STR);
$query->bindParam(':ct',$c,PDO::PARAM_STR);
$query->bindParam(':wt',$c,PDO::PARAM_STR);
$query->bindParam(':pro',$c,PDO::PARAM_STR);
$query->bindParam(':ter',$c,PDO::PARAM_STR);
$query->execute();
